...
location_one = Location.create(country: 'USA', lat: 39.742043, long: -104.991531)
location_two = Location.create(country: 'USA', lat: 37.09024, long: -95.712891)
location_three = Location.create(country: 'USA', lat: 39.742043, long: -104.991531)
location_four = Location.create(country: 'Italy', lat: 41.87194, long: 12.56738)
location_five = Location.create(country: 'France', lat: 46.227638, long: 2.213749)
location_six = Location.create(country: 'United Kingdom', lat: 55.378051, long: -3.435973)
location_seven = Location.create(country: 'South Africa', lat: -30.559482, long: 22.937506)
